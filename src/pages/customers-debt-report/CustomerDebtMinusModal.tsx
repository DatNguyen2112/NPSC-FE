...
export default function CustomerDebtMinusModal({ customerId }: { customerId?: string }): React.ReactElement {
  ...
  return (
    <Modal
      width={960}
      title={'Công nợ khách hàng giảm trong kỳ'}
      open={debtTransactionFacade.isDebtReportModalNegativeCustomerVisible}
      onCancel={() => debtTransactionFacade.set({ isDebtReportModalNegativeCustomerVisible: false })}
      footer={null}
    >
