...
export default function SupplierDebtPositiveModal({ supplierId }: { supplierId?: string }): React.ReactElement {
  ...
  return (
    <Modal
      width={960}
      title={'Công nợ nhà cung cấp tăng trong kỳ'}
      open={debtTransactionFacade.isDebtReportModalPositiveSupplierVisible}
      onCancel={() => debtTransactionFacade.set({ isDebtReportModalPositiveSupplierVisible: false })}
      footer={null}
    >
