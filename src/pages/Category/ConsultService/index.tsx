...
const Page: React.FC = () => {
  ...
  if (!parsedFilter.type) {
    parsedFilter.type = 'CONSULT_SERVICE';
  }
  ...
  const dataSource: DataType[] =
    codeTypeFacade.consultServiceData?.content.map(
  ...
  const onChangeDataTable = (props: { query?: QueryParams; setKeyState?: object }) => {
    ...
    codeTypeFacade.getConsultService(fillQuery);
    navigate(
  ...
  const column: ColumnsType<DataType> = [
    ...
    {
      title: <span>Mã loại dịch vụ tư vấn</span>,
      dataIndex: 'code',
      key: 'code',
      width: 200,
    },
    {
      title: 'Tên loại dịch vụ tư vấn',
      dataIndex: 'title',
      key: 'title',
      render: (value, record) => (
        <Space>
